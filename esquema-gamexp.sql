...
CREATE TABLE TIPO_PROFISSAO (
    ...
    MELHOR_OBRA BYTEA, /* Pode-se usar BYTEA, para conter um arquivo
...
CREATE TABLE PORTFOLIO (
    ...
    ARTE BYTEA NOT NULL,/* VISTO QUE É IMAGEM */
...
APENAS NOME_ARTISTICO E ARTE, NAO SERIA POSSIVEL DEFINIR A CHAVE PRIMARIA COM ARTE SENDO DO TIPO BYTEA */
...
CREATE TABLE VENDA (
    ...
    NOME_ARTISTICO VARCHAR(30) NOT NULL,
    TIPO VARCHAR(20) NOT NULL,
    NOTA_FISCAL BYTEA NOT NULL,/* NOTA FISCAL SERIA UM BYTEA OU STRING???? */
